...
public class ChooseInterestFragment extends BaseFragment implements BubblePickerListener {
    ...
    public ArrayList<PickerItem> getItems() {
        ...
        itemList.add(new PickerItem(getResources().getString(R.string.soul), getResources().getDrawable(R.drawable.ic_god),
                ICON_ON_TOP, BUBBLE_COLOR, BUBBLE_GRADIENT, OVERLAY_ALPHA, Typeface.DEFAULT_BOLD, TEXT_COLOR,
                TEXT_SIZE, getResources().getDrawable(R.drawable.background)));

        itemList.add(new PickerItem(getResources().getString(R.string.karma), getResources().getDrawable(R.drawable.ic_karma),
                ICON_ON_TOP, BUBBLE_COLOR, BUBBLE_GRADIENT, OVERLAY_ALPHA, Typeface.DEFAULT_BOLD, TEXT_COLOR,
                TEXT_SIZE, getResources().getDrawable(R.drawable.background)));
        ...
        itemList.add(new PickerItem(getResources().getString(R.string.god), getResources().getDrawable(R.drawable.ic_god),
                ICON_ON_TOP, BUBBLE_COLOR, BUBBLE_GRADIENT, OVERLAY_ALPHA, Typeface.DEFAULT_BOLD, TEXT_COLOR, TEXT_SIZE,
                getResources().getDrawable(R.drawable.background)));

        itemList.add(new PickerItem(getResources().getString(R.string.meditation), getResources().getDrawable(R.drawable.ic_meditation),
                ICON_ON_TOP, BUBBLE_COLOR, BUBBLE_GRADIENT, OVERLAY_ALPHA, Typeface.DEFAULT_BOLD, TEXT_COLOR,
                TEXT_SIZE, getResources().getDrawable(R.drawable.background)));
        ...
        itemList.add(new PickerItem(getResources().getString(R.string.love), getResources().getDrawable(R.drawable.ic_love),
                ICON_ON_TOP, BUBBLE_COLOR, BUBBLE_GRADIENT, OVERLAY_ALPHA, Typeface.DEFAULT_BOLD, TEXT_COLOR,
                TEXT_SIZE, getResources().getDrawable(R.drawable.background)));

        itemList.add(new PickerItem(getResources().getString(R.string.peace), getResources().getDrawable(R.drawable.ic_peace),
                ICON_ON_TOP, BUBBLE_COLOR, BUBBLE_GRADIENT, OVERLAY_ALPHA, Typeface.DEFAULT_BOLD, TEXT_COLOR,
                TEXT_SIZE, getResources().getDrawable(R.drawable.background)));
